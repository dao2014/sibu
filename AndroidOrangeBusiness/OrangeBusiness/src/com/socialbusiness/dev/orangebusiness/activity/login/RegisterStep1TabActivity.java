...
import com.socialbusiness.dev.orangebusiness.fragment.register.UserRegisterFrament;

/**
 * Created by zkboos on 2015/4/8.
 */
public class RegisterStep1TabActivity extends BaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.register_step1_tab);
        findView();
        initViewPager();
        updateTabView();
        setListeners();
...
//                }
    ...
    private class OrderPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position){
                case 0 :{
                    return new UserRegisterFrament();
                }
                case 1 : {
                    UserRegisterFrament temp=new UserRegisterFrament();
                    temp.hideSuperLevel();
                    return temp;
                }
            }
