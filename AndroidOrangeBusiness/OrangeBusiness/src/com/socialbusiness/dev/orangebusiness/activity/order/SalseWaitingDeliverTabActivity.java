...
import com.socialbusiness.dev.orangebusiness.fragment.order.SalseWaitingDeliverNoTransitionFrament;
import com.socialbusiness.dev.orangebusiness.fragment.order.SalseWaitingDeliverTransitionFrament;

/**
 * 待发货订单
 */
public class SalseWaitingDeliverTabActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.salse_waiting_deliver_order_tab);
        findView();
        initViewPager();
        updateTabView();
        setListeners();
...
//                }
    ...
    private class OrderPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0: {
                    return new SalseWaitingDeliverNoTransitionFrament();  //未转采购
                }
                case 1: {
                    SalseWaitingDeliverTransitionFrament temp = new SalseWaitingDeliverTransitionFrament();  //已转采购
                    return temp;
                }
            }
            return null;
