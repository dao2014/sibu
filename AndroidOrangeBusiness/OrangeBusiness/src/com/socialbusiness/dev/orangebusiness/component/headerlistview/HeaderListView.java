package com.socialbusiness.dev.orangebusiness.component.headerlistview;
...
public class HeaderListView extends RelativeLayout {
                ...
                if (mAdapter != null) {
                    ...
                    if(mOnItemClickListener != null) {
                    	mOnItemClickListener.onItemClick(parent, view, 
                    			mAdapter.getSection(position), mAdapter.getRowInSection(position), position, id);
                    }
                }
            }
        });
    ...
    public void setScrollBarVisible(boolean visible) {
    	if(mScrollView != null) {
    		mScrollView.setVisibility(visible ? View.VISIBLE : View.INVISIBLE);
    	}
    }
    ...
    private class HeaderListViewOnScrollListener implements AbsListView.OnScrollListener {
        ...
        public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
            ...
            if (firstVisibleItem < 0 || mAdapter.disableHeaders()) {
        ...
        private void addSectionHeader(int actualSection) {
            ...
            if (mAdapter.hasSectionHeaderView(actualSection)) {
                View header = mAdapter.getSectionHeaderView(actualSection, null, mListView);
    ...
    public static interface OnItemClickListener {
    	void onItemClick(AdapterView<?> parent, View view, int section, int row, int globalPosition, long id);
    }
}
