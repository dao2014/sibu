...
public class DeliverDoneFragment extends BaseFragment {

	public static final String TAG = "DeliverDoneFragment";
		...
		mListView.getRefreshableView().setOnGroupClickListener(
				new OnGroupClickListener() {
					...
					public boolean onGroupClick(ExpandableListView parent,
                        ...
                        startActivityForResult(intent, Constant.REQUESTCODE_DELIVERED);
						return true;
					}
				});
    ...
    private void doPullDownToRefresh() {
		mCurpage = 1;
		callAPIListOrder();
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == Constant.REQUESTCODE_DELIVERED && resultCode == Constant.RESULTCODE_OK) {
            doPullDownToRefresh();
        }
    }
    ...
    private void callAPIListOrder() {
		...
		APIManager.getInstance(getActivity()).listOrderByBuyerDelivered(
