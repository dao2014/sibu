...
import com.socialbusiness.dev.orangebusiness.adapter.OrderAdapter.OnCancelChangedListener;
...
public class WaitingConfirmFragment extends BaseFragment {
    ...
    public static final String TAG = "WaitingConfirmFragment";
    ...
    private void setListener() {
        ...
        mAdapter.setOnCancelChangedListener(new OnCancelChangedListener() {
    ...
    private void callAPIListOrder() {
        ...
        APIManager.getInstance(getActivity()).listOrderByBuyerWaitingHandle(
