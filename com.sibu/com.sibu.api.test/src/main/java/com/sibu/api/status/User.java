...
public class User {
	...
	@ResponseBody
	@RequiresGuest  
	public String test(String username, String password, String version,
	...
	@ResponseBody
	public String test2(String username, String password, String version,
			HttpServletRequest req, HttpServletResponse res) throws Exception {
		if (Version.V10.equals(version)) {
			String exceptionClassName = (String) req
					.getAttribute("shiroLoginFailure");
