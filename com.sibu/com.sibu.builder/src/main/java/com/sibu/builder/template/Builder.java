package com.sibu.builder.template;
...
import com.sibu.common.builder.bean.BuilderBean;
import com.sibu.common.builder.bean.FieldBean;
import com.sibu.common.builder.bean.JavaCodeBean;
import com.sibu.common.builder.util.AutoCompleteUtil;
import com.sibu.common.util.SpringUtil;
...
public class Builder {
	...
	static {
		...
		/** 生成代码存放的主包名 */
		builderBean.setTargetMainPackageName("com.sibu.dao.user.vo");
		
		// TODO 在这里修改必要参数  
		/** 作者 */ 
		builderBean.setAuthor("dao");
		/** 主名字 */
		builderBean.setMyName("user");
		/** 表名 */
		builderBean.setTableName("user");
		/** ID名 */
		builderBean.setIdName("id");
...
//		createAllFieldJava(); //创建数据库中所有表的字段枚举类
	...
	public static Connection getConnection() throws Exception {
		if (null == conn) {
			conn = ((ComboPooledDataSource) SpringUtil.getBeanById(dateSourceBeanId)).getConnection();
		}
		return conn;
	}
